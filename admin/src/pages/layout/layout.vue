                ...
                <li v-if="user" class="menu-item" style="padding: 0;">
                    ...
                    >
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item command="a" @click.native="exit">退出</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </li>
            </ul>
...
export default {
            ...
            sider_menu_data: [
                {
                    ...
                    children: [
                        { path: "/home/1", title: "活动资讯" },
                        { path: "/home/2", title: "电子烟资讯" },
                        { path: "/home/3", title: "纹身资讯" },
                    ]
                },
            ],
            isCollapsed: false,
    ...
    computed: {
        user() {
            return this.$store.state.user || sessionStorage.getItem("user");
        }
    },
    methods: {
        checkAuth() {
